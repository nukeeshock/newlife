...
export default function FAQPage() {
  return (
    <main className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative flex min-h-[50vh] items-center justify-center px-6 pt-32 pb-20 overflow-hidden">
        {/* Background Image */}
        <div className="absolute inset-0 z-0">
          <Image
            src="/bg-faq.png"
            alt="NewLife Vietnam FAQ - Zen Garden"
            fill
      ...
      <div className="mx-auto w-full max-w-4xl px-6 py-16 md:px-8">
        {/* Divider */}
