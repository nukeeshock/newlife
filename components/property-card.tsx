...
export function PropertyCard({
  ...
  const handleWhatsAppClick = async (e: MouseEvent) => {
    ...
    window.open(`https://wa.me/84832114684?text=${text}`, "_blank", "noopener,noreferrer");
  };
  ...
  return (
    <div className="flex flex-col">
      ...
      >
        ...
        >
          {images[activeImage] ? (
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-[#F5F0EB] text-[--muted]">
      ...
      {isAuthenticated && (
        <div className="rounded-b-sm border border-t-0 border-[--border] bg-[#F5F0EB] p-4">
