    ...
    >
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-5 md:px-8">
        ...
        <nav className="hidden items-center gap-8 lg:flex">
          {/* Immobilien - Direct Link (no dropdown) */}
          <Link
            href="/immobilien"
          ...
          >
            ...
            >
              <div className="border border-[--glass-border] bg-[#0a0b10] shadow-xl">
                {cityLinks.map((city) => (
                  <Link
                    key={city.href}
                    href={city.href}
                    onClick={() => setCitiesOpen(false)}
                    className="block px-5 py-3 text-sm font-medium tracking-wide text-[--text] transition-colors duration-200 hover:bg-[--primary]/10 hover:text-[--primary]"
                  >
                    {city.label}
                  </Link>
                ))}
      ...
      >
        <nav className="mx-auto flex w-full max-w-6xl flex-col px-6 py-4 md:px-8">
          ...
          <a
            ...
            onClick={() => setMobileOpen(false)}
            className="mt-6 flex items-center justify-center gap-3 border border-[--primary] bg-[--primary] py-4 text-base font-medium tracking-wide text-[--bg] transition-all hover:bg-transparent hover:text-[--primary]"
          >
