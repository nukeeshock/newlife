  ...
  return (
    <section className="relative flex min-h-[85vh] flex-col items-center justify-center overflow-hidden px-6 pt-32 pb-20 md:min-h-[90vh] md:px-8">
      ...
      <div className="pointer-events-none absolute inset-0 z-10 overflow-hidden">
        ...
        <div className="absolute left-0 top-0 h-32 w-px bg-gradient-to-b from-[--primary]/40 to-transparent" />
        <div className="absolute left-0 top-0 h-px w-32 bg-gradient-to-r from-[--primary]/40 to-transparent" />
        <div className="absolute bottom-0 right-0 h-32 w-px bg-gradient-to-t from-[--primary]/40 to-transparent" />
        <div className="absolute bottom-0 right-0 h-px w-32 bg-gradient-to-l from-[--primary]/40 to-transparent" />
      </div>
      ...
      <div className="relative z-20 mx-auto flex max-w-4xl flex-col items-center text-center">
        ...
        <h1 className="font-serif text-5xl font-light leading-[1.1] tracking-tight text-[--accent] md:text-6xl lg:text-7xl xl:text-8xl">
          Ihr neues Kapitel
          <br />
        ...
        {/* Trust Indicators */}
        <div className="mt-16 flex flex-col items-center gap-6 rounded-sm bg-white/80 px-8 py-4 shadow-sm backdrop-blur-sm sm:flex-row sm:gap-12">
