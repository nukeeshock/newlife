        ...
        <nav className="mx-auto flex w-full max-w-6xl flex-col px-6 py-4 md:px-8">
          {navLinks.map((link, i) => (
            <Link
              ...
              className={`border-b border-[--glass-border] py-5 text-base font-medium tracking-wide text-[--text] transition-colors hover:text-[--primary] active:scale-[0.98] ${mobileOpen ? "animate-slideInLeft opacity-0-initial" : ""}`}
          ...
          <Link
            href="/immobilien"
            onClick={() => setMobileOpen(false)}
            className={`mt-4 flex items-center justify-center gap-2 border border-[--glass-border] py-4 text-sm font-medium tracking-wide text-[--muted] transition-all duration-300 hover:border-[--primary] hover:text-[--primary] active:scale-[0.98] ${mobileOpen ? "animate-slideInLeft opacity-0-initial" : ""}`}
          ...
          <a
            ...
            onClick={() => setMobileOpen(false)}
            className={`mt-4 flex items-center justify-center gap-3 border border-[--primary] bg-[--primary] py-4 text-base font-medium tracking-wide text-white transition-all duration-300 hover:bg-transparent hover:text-[--primary] active:scale-[0.98] ${mobileOpen ? "animate-fadeInUp opacity-0-initial" : ""}`}
