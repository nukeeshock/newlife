        ...
        <div className="grid gap-16 md:grid-cols-2">
          <div>
            ...
            <p className="mb-6 text-lg leading-relaxed text-[--muted]">
              Viele Menschen ab 50+ fuehlen sich im Alltag isoliert. In unseren{" "}
              <strong className="text-[--text]">Shared Living Villen</strong> kombinieren wir
              Privatsphaere mit Gesellschaft.
            </p>
            <p className="text-lg leading-relaxed text-[--muted]">
              Sie haben Ihr eigenes Reich (Schlafzimmer &amp; Bad) als Rueckzugsort, teilen
              sich aber grosszuegige Wohnbereiche, den Garten und den Pool mit gleichgesinnten
              Mitbewohnern.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="border border-white/5 bg-[--surface] p-6">
              ...
              <h3 className="mb-2 font-bold text-[--text]">Privatsphaere</h3>
              <p className="text-sm text-[--muted]">Eigenes Zimmer &amp; Bad in Top-Qualitaet.</p>
            </div>
            <div className="border border-white/5 bg-[--surface] p-6">
              <svg
                aria-hidden="true"
